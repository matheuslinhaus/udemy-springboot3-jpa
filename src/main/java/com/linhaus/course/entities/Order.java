...
public class Order implements Serializable {
	...
	//Anotações para 1 para 1 parte da classe principal
	//O atributo cascade se refere mapear com o mesmo Id
	//Se o pedido foi id 45 o pagamento terá id 45 também
